  ...
  return (
    <div className="w-full max-w-[408px] cursor-pointer">
      <Select defaultValue="Notifications">
        ...
        <SelectTrigger className="w-[100%] h-[40px] p-3 title-medium leading-normal font-semibold text-[#0E1726] text-opacity-80 bg-white rounded-[10px] border-none shadow-md truncate">
